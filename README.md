...
| **最近核对** | 2026-09-20 —— 本仓库的扩展源码与所分发 App 为同一版本；内核版本固定不变（见下节） |

> **对应关系说明**：GPL 义务针对的是**扩展与构建脚本这部分源码**。
> 网络内核是上游 sing-box `v1.14.0`、未作任何修改，因此只要 App 仍使用该版本内核，
> 本仓库即持续构成其完整对应源码；App 的界面与业务代码不是 GPL 组件，不在本仓库范围内。
